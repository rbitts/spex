...
let OverwatchProvider = function () {
    ...
    let parseProfile = ($) => {
        ...
        stats.levelBasePicture = $('div.player-level').css('background-image').replace("url(", "").replace(')', "");
        stats.level = parseInt($('div.player-level div').first().text());
        stats.levelPicture = $('div.player-rank').length != 0 ? $('div.player-rank').css('background-image').replace("url(", "").replace(')', ""):"";
